...
public class ShipmentService extends BasedService{
    ...
    ShipmentRepository shipmentRepository;
        public Map<String, Object> getShipmentByFilter(FilterModel filterModel) {
        ...
        List<Shipment> shipmentList = shipmentRepository.findShipmentByFilterForTable(
                ...
                filterMap.get("marginPercentageFilter"),filterMap.get("fromDateFilter"),filterMap.get("toDateFilter"),
